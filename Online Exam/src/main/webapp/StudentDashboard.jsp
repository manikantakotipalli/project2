    ...
    <div class="container-fluid" style="padding-top:100px;">
        <div class="row" style="display: flex;">
            <div class="col-md-4">
                <div class="cardBox">
                    <div class="card">
                        <div class="numbers">Student Details</div>
                ...
                <div class="cardBox">
                    <div class="card">
                        <div class="numbers">Take Test</div>
                        <div class="iconbox btn">
                            <a href="startexam.jsp" style="COLOR:BLACK"><ion-icon name="book-outline"></ion-icon></a>
                ...
                <div class="cardBox">
                    <div class="card">
                        <div class="numbers">Update Details</div>
                        <div class="iconbox btn" >
